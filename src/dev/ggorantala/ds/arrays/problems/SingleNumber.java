...
/**
 * This class provides methods to find the single number in an array where every other number
 * appears exactly twice. It includes three approaches: using a hash table, a mathematical approach,
 * and an optimal approach using bitwise XOR.
 *
 * @author ggorantala
 */
